...
<div class="container">
    ...
    <div class="card-container">
        ...
        @foreach($destinations as $destination)
            <div class="card">
                <img class="card-img"
                    src="{{ !empty($destination->image) ? url('assets/img/destinations/' . $destination->image) : url('assets/img/hero.jpg') }}"
    ...
    <div class="card-container">
        ...
        @foreach($facilities as $facility)
            <div class="card">
                <img src="{{ asset('storage/' . $facility->image) }}" alt="{{ $facility->name }}" class="card-img">
                <div class="card-body">
