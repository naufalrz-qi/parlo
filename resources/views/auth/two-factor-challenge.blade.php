            ...
            <div class="card mt-2" style="display: block;" id="secretCodeForm">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('two-factor.login') }}">
                        ...
                        <div class="mb-3 row">
                            <label for="code" class="col-4 col-form-label text-md-end">{{ __('Secret Code') }}</label>
                            <div class="col-6">
            ...
            <div class="card mt-2" style="display: none;" id="recoveryCodeForm">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('two-factor.login') }}">
                        ...
                        <div class="mb-3 row">
                            <label for="recovery_code" class="col-4 col-form-label text-md-end">{{ __('Recovery Code:') }}</label>
                            <div class="col-6">
